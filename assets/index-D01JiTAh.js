import{_ as y}from"./vendor-B0ga06J7.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();function h(o){return o.toString().replace(/\B(?=(\d{3})+(?!\d))/g," ")}function I(o="INV"){const e=Date.now().toString().slice(-6),t=Math.floor(Math.random()*1e3).toString().padStart(3,"0");return`${o}-${e}-${t}`}async function w(o){if(!o||!o.trim())return null;try{const{decodeInvoice:e}=await y(async()=>{const{decodeInvoice:n}=await import("./index.modern-DRrZddpj.js");return{decodeInvoice:n}},[]);return e(o.trim())}catch(e){return console.error("Error decoding Lightning invoice:",e),null}}function T(o){return o?/^lnbc[0-9]+[munp]?[0-9]*[a-z0-9]+$/i.test(o.trim()):!0}function x(){return{invoiceDate:new Date().toISOString().split("T")[0]}}function L(o,e){return(parseInt(o)||0)*(parseInt(e)||0)}function d(o,e="success"){const t=document.createElement("div");t.className=`notification notification-${e}`,t.textContent=o,Object.assign(t.style,{position:"fixed",top:"20px",right:"20px",padding:"15px 20px",borderRadius:"8px",color:"white",fontWeight:"bold",zIndex:"1000",transform:"translateX(100%)",transition:"transform 0.3s ease",maxWidth:"300px",wordWrap:"break-word"});const n={success:"#10b981",error:"#ef4444",warning:"#f59e0b"};t.style.backgroundColor=n[e]||n.success,document.body.appendChild(t),setTimeout(()=>{t.style.transform="translateX(0)"},100),setTimeout(()=>{t.style.transform="translateX(100%)",setTimeout(()=>{document.body.removeChild(t)},300)},3e3)}function S(o,e){let t;return function(...i){const r=()=>{clearTimeout(t),o(...i)};clearTimeout(t),t=setTimeout(r,e)}}function E(o){const e=document.createElement("div");return e.textContent=o,e.innerHTML}const f={FORM_DATA:"bullish_invoice_form_data",TEMPLATES:"bullish_invoice_templates",SETTINGS:"bullish_invoice_settings"};function C(o){try{localStorage.setItem(f.FORM_DATA,JSON.stringify(o))}catch(e){console.error("Error saving form data:",e)}}function P(){try{const o=localStorage.getItem(f.FORM_DATA);return o?JSON.parse(o):null}catch(o){return console.error("Error loading form data:",o),null}}function _(o,e){try{const t=b();t[o]={...e,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()},localStorage.setItem(f.TEMPLATES,JSON.stringify(t))}catch(t){console.error("Error saving template:",t)}}function b(){try{const o=localStorage.getItem(f.TEMPLATES);return o?JSON.parse(o):{}}catch(o){return console.error("Error loading templates:",o),{}}}function F(o){try{return b()[o]||null}catch(e){return console.error("Error loading template:",e),null}}function k(){try{const o=b();return Object.keys(o)}catch(o){return console.error("Error getting template names:",o),[]}}function M(){try{const o=localStorage.getItem(f.SETTINGS);return o?JSON.parse(o):D()}catch(o){return console.error("Error loading settings:",o),D()}}function D(){return{autoSave:!0,autoSaveInterval:5e3,defaultInvoicePrefix:"INV",defaultCurrency:"sats",theme:"dark"}}async function A(o,e){try{const t=event.target,n=t.innerHTML;t.innerHTML="⏳ Generating...",t.disabled=!0;const i=(await y(async()=>{const{default:a}=await import("./vendor-B0ga06J7.js").then(l=>l.h);return{default:a}},[])).default,r=await i(o,{backgroundColor:"#ffffff",scale:2,useCORS:!0,allowTaint:!1,logging:!1,scrollX:0,scrollY:0}),s=document.createElement("a");s.download=`${e}.png`,s.href=r.toDataURL("image/png"),document.body.appendChild(s),s.click(),document.body.removeChild(s),t.innerHTML=n,t.disabled=!1,d("Image exported successfully!","success")}catch(t){console.error("Error exporting image:",t),d("Error exporting image. Please try again.","error");const n=event.target;n.innerHTML="🖼️ Export Image",n.disabled=!1}}async function O(o,e){try{const t=event.target,n=t.innerHTML;t.innerHTML="⏳ Generating...",t.disabled=!0;const i=(await y(async()=>{const{default:c}=await import("./vendor-B0ga06J7.js").then(p=>p.h);return{default:c}},[])).default,{jsPDF:r}=await y(async()=>{const{jsPDF:c}=await import("./vendor-B0ga06J7.js").then(p=>p.j);return{jsPDF:c}},[]),s=await i(o,{backgroundColor:"#ffffff",scale:2,useCORS:!0,allowTaint:!1,logging:!1,scrollX:0,scrollY:0}),a=new r("p","mm","a4"),l=s.toDataURL("image/png"),v=210,m=295,u=v,g=s.height*u/s.width;if(g<=m){const c=(m-g)/2;a.addImage(l,"PNG",0,c,u,g)}else{let c=g,p=0;for(a.addImage(l,"PNG",0,p,u,g),c-=m;c>=0;)p=c-g,a.addPage(),a.addImage(l,"PNG",0,p,u,g),c-=m}a.save(`${e}.pdf`),t.innerHTML=n,t.disabled=!1,d("PDF exported successfully!","success")}catch(t){console.error("Error exporting PDF:",t),d("Error exporting PDF. Please try again.","error");const n=event.target;n.innerHTML="📄 Export PDF",n.disabled=!1}}function $(o){try{const e=document.createElement("div");e.style.position="fixed",e.style.left="-9999px",e.style.top="-9999px",e.style.width="8.5in",e.style.height="11in",e.style.backgroundColor="white",e.style.padding="0.5in",e.style.boxSizing="border-box",e.style.fontFamily="Arial, sans-serif",e.style.color="black",e.style.overflow="hidden";const t=o.cloneNode(!0);e.appendChild(t),document.body.appendChild(e);const n=document.createElement("style");n.textContent=`
            @media print {
                body * {
                    visibility: hidden;
                }
        ...
        `,e}saveCurrentTemplate(){const e=prompt("Enter template name:");if(e&&e.trim()){const t=this.getFormData();_(e.trim(),t),d(`Template "${e}" saved successfully!`,"success")}}loadTemplateDialog(){const e=k();if(e.length===0){d("No saved templates found.","warning");return}const t=e.map(i=>`<option value="${i}">${i}</option>`).join(""),n=document.createElement("div");n.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
