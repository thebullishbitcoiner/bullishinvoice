import{_ as v}from"./vendor-B0ga06J7.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function n(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(t){if(t.ep)return;t.ep=!0;const o=n(t);fetch(t.href,o)}})();function I(r){return r.toString().replace(/\B(?=(\d{3})+(?!\d))/g," ")}function w(r="INV"){const e=Date.now().toString().slice(-6),n=Math.floor(Math.random()*1e3).toString().padStart(3,"0");return`${r}-${e}-${n}`}function L(){return{invoiceDate:new Date().toISOString().split("T")[0]}}function m(r,e="success"){const n=document.createElement("div");n.className=`notification notification-${e}`,n.textContent=r,Object.assign(n.style,{position:"fixed",bottom:"20px",left:"20px",padding:"15px 20px",borderRadius:"8px",color:"white",fontWeight:"bold",zIndex:"1000",transform:"translateX(-100%)",transition:"transform 0.3s ease",maxWidth:"300px",wordWrap:"break-word"});const i={success:"#ff9900",error:"#ff9900",warning:"#ff9900"};n.style.backgroundColor=i[e]||i.success,document.body.appendChild(n),setTimeout(()=>{n.style.transform="translateX(0)"},100),setTimeout(()=>{n.style.transform="translateX(-100%)",setTimeout(()=>{document.body.removeChild(n)},300)},3e3)}function B(r,e){let n;return function(...t){const o=()=>{clearTimeout(n),r(...t)};clearTimeout(n),n=setTimeout(o,e)}}function E(r){const e=document.createElement("div");return e.textContent=r,e.innerHTML}const y={FORM_DATA:"bullishinvoice_formData",TEMPLATES:"bullishinvoice_templates",SETTINGS:"bullishinvoice_settings"};function M(r){try{localStorage.setItem(y.FORM_DATA,JSON.stringify(r))}catch(e){console.error("Error saving form data:",e)}}function N(){try{const r=localStorage.getItem(y.FORM_DATA);return r?JSON.parse(r):null}catch(r){return console.error("Error loading form data:",r),null}}function C(r,e){try{const n=x();n[r]={...e,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()},localStorage.setItem(y.TEMPLATES,JSON.stringify(n))}catch(n){console.error("Error saving template:",n)}}function x(){try{const r=localStorage.getItem(y.TEMPLATES);return r?JSON.parse(r):{}}catch(r){return console.error("Error loading templates:",r),{}}}function q(r){try{return x()[r]||null}catch(e){return console.error("Error loading template:",e),null}}function k(r){try{const e=x();delete e[r],localStorage.setItem(y.TEMPLATES,JSON.stringify(e))}catch(e){console.error("Error deleting template:",e)}}function $(){try{const r=x();return Object.keys(r)}catch(r){return console.error("Error getting template names:",r),[]}}function _(){try{const r=localStorage.getItem(y.SETTINGS);return r?JSON.parse(r):D()}catch(r){return console.error("Error loading settings:",r),D()}}function D(){return{autoSave:!0,autoSaveInterval:5e3,defaultInvoicePrefix:"INV",defaultCurrency:"sats",theme:"dark"}}class P{constructor(){this.isProcessing=!1,this.currentInvoice=null,this.qrElement=null,this.paymentCompleted=!1,this.debugMode=this.detectDebugMode(),this.debugMode&&(console.log("🚀 LightningPayment initialized with DEBUG MODE ENABLED"),console.log("   Exports will skip payment and execute directly")),window.toggleDebugMode=()=>this.toggleDebugMode(),window.redetectDebugMode=()=>this.redetectDebugMode()}async createInvoice(){try{const{LightningAddress:e}=await v(async()=>{const{LightningAddress:t}=await import("./index.modern-GuuHck_z.js");return{LightningAddress:t}},[]),n=new e("bullish@getalby.com");await n.fetch();const i=await n.requestInvoice({satoshi:21,description:"Export payment for bullishInvoice",expiry:86400});return console.log("Invoice created:",{paymentRequest:i.paymentRequest,paymentHash:i.paymentHash,satoshi:i.satoshi}),i}catch(e){throw console.error("Error creating invoice:",e),new Error("Failed to create Lightning invoice")}}async displayInvoice(e,n){try{const i=document.querySelector("#qr-container");if(!i)throw new Error("QR container not found");const t=document.createElement("bitcoin-qr");t.setAttribute("width","400"),t.setAttribute("height","400"),t.setAttribute("lightning",e.paymentRequest),t.setAttribute("is-polling","true"),t.setAttribute("poll-interval","3000"),t.setAttribute("type","svg"),t.setAttribute("corners-square-color","#ff9900"),t.setAttribute("corners-dot-color","#ff9900"),t.setAttribute("corners-square-type","square"),t.setAttribute("dots-type","square"),t.setAttribute("dots-color","#ff9900"),t.callback=async()=>{await this.checkPaymentStatus(e,n)},i.appendChild(t),this.qrElement=t,console.log("QR code displayed for invoice:",e.paymentRequest)}catch(i){throw console.error("Error displaying invoice with bitcoin-qr:",i),new Error("Failed to display invoice")}}createModalOverlay(){const e=document.createElement("div");return e.id="payment-overlay",e.style.cssText=`
        ...
        `,document.head.appendChild(n),document.body.appendChild(e),e}removeExportProcessingModal(){const e=document.getElementById("export-processing-overlay");e&&e.remove()}async checkPaymentStatus(e,n){if(!this.paymentCompleted)try{if(await e.verifyPayment()&&e.preimage){console.log("Payment verified successfully!"),console.log(`Preimage: ${e.preimage}`),this.paymentCompleted=!0,this.qrElement&&this.qrElement.setAttribute("is-polling","false");const t=document.getElementById("payment-status");t&&(t.textContent="✅ Payment received! Processing export...",t.style.color="#10b981"),this.createExportProcessingModal(),n(!0)}}catch(i){console.error("Error checking payment status:",i)}}cancelPayment(){this.qrElement&&(this.qrElement.remove(),this.qrElement=null),this.isProcessing=!1,this.currentInvoice=null,this.paymentCompleted=!1,this.removeModalOverlay(),m("Payment cancelled.","info")}async handleExportPayment(e,n){if(this.isProcessing){m("Payment already in progress. Please wait.","warning");return}if(this.debugMode){console.log("🐛 DEBUG MODE: Skipping Lightning payment, executing export directly"),m("Debug mode: Skipping payment, exporting directly...","info");try{await e(...n),m("Export completed (debug mode)!","success")}catch(i){console.error("Error in debug export:",i),m("Error during debug export. Please try again.","error")}return}this.isProcessing=!0,this.paymentCompleted=!1,this.createModalOverlay();try{m("Creating Lightning invoice...","info");const i=await this.createInvoice();this.currentInvoice=i,console.log("Created invoice:",{paymentRequest:i.paymentRequest,paymentHash:i.paymentHash,satoshi:i.satoshi}),m("Invoice created! Please scan QR code to pay.","success"),await this.displayInvoice(i,async t=>{var o;if(t){m("Payment received! Processing export...","success"),console.log("Payment verified successfully!");const s=(o=this.currentInvoice)==null?void 0:o.preimage;s&&console.log(`Preimage: ${s}`);try{await e(...n);const d=document.getElementById("export-status");d&&(d.textContent="Export completed successfully!",d.style.color="#10b981");const l=document.getElementById("export-processing-overlay");if(l){const a=l.querySelector("div > div");a&&(a.innerHTML=`
            ...
            `);const e=document.getElementById("hamburgerBtn"),n=document.getElementById("menuOverlay"),i=document.getElementById("menuSidebar"),t=document.getElementById("menuCloseBtn"),o=()=>{e.classList.toggle("active"),n.classList.toggle("active"),i.classList.toggle("active"),t.classList.toggle("active")};e.addEventListener("click",o),n.addEventListener("click",o),t.addEventListener("click",o),document.getElementById("menuGenerateInvoice").addEventListener("click",()=>{this.generateNewInvoiceNumber(),o()}),document.getElementById("menuClearForm").addEventListener("click",()=>{this.clearForm(),o()}),document.getElementById("menuSaveTemplate").addEventListener("click",()=>{this.saveCurrentTemplate()}),this.refreshTemplateList()}refreshTemplateList(){const e=document.getElementById("templateList"),n=$();if(n.length===0){e.innerHTML='<div class="no-templates">No templates saved</div>';return}let i="";n.forEach(t=>{i+=`
            ...
            `}),e.innerHTML=i}loadTemplateByName(e){const n=q(e);n&&(this.setFormData(n),this.updatePreview(),this.saveFormData(),m(`Template "${e}" loaded successfully!`,"success"),document.getElementById("hamburgerBtn").classList.remove("active"),document.getElementById("menuOverlay").classList.remove("active"),document.getElementById("menuSidebar").classList.remove("active"),document.getElementById("menuCloseBtn").classList.remove("active"))}deleteTemplateByName(e){confirm(`Are you sure you want to delete the template "${e}"?`)&&(k(e),m(`Template "${e}" deleted successfully!`,"success"),this.refreshTemplateList())}saveCurrentTemplate(){const e=document.createElement("div");e.className="template-modal-overlay",e.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
        ...
        `,document.body.appendChild(e);const n=e.querySelector("#templateNameInput");setTimeout(()=>n==null?void 0:n.focus(),100);const i=e.querySelector("#infoIcon"),t=e.querySelector("#infoTooltip");i&&t&&(i.addEventListener("mouseenter",()=>{t.style.opacity="1"}),i.addEventListener("mouseleave",()=>{t.style.opacity="0"}));const o=e.querySelector("#cancelSaveBtn"),s=e.querySelector("#saveBtn");o&&(o.addEventListener("mouseenter",()=>{o.style.background="rgba(255, 255, 255, 0.2)",o.style.transform="translateY(-2px)"}),o.addEventListener("mouseleave",()=>{o.style.background="rgba(255, 255, 255, 0.1)",o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{e.remove()})),s&&(s.addEventListener("mouseenter",()=>{s.style.transform="translateY(-2px)",s.style.boxShadow="0 5px 15px rgba(255, 153, 0, 0.4)"}),s.addEventListener("mouseleave",()=>{s.style.transform="translateY(0)",s.style.boxShadow="none"}),s.addEventListener("click",()=>{var l,a,u,f;const d=n==null?void 0:n.value;if(d&&d.trim()){const h={fromName:((l=document.getElementById("fromName"))==null?void 0:l.value)||"",toName:((a=document.getElementById("toName"))==null?void 0:a.value)||"",lightningAddress:((u=document.getElementById("lightningAddress"))==null?void 0:u.value)||"",notes:((f=document.getElementById("notes"))==null?void 0:f.value)||""};C(d.trim(),h),m(`Template "${d}" saved successfully!`,"success"),this.refreshTemplateList(),e.remove()}else m("Please enter a template name","warning")})),e.addEventListener("click",d=>{d.target===e&&e.remove()}),n&&n.addEventListener("keypress",d=>{d.key==="Enter"&&(s==null||s.click())})}loadVersion(){try{const e="0.0.17",n=document.getElementById("versionDisplay");n&&(n.textContent=`v${e}`)}catch{console.log("Could not load version, using default")}}updateQRCodeSize(){const e=document.querySelector("#qrCodeContainer bitcoin-qr");if(!e)return;const n=Math.min(Math.floor(window.innerWidth/3),300),i=Math.round(n/100)*100;e.setAttribute("width",i),e.setAttribute("height",i)}updateQRCode(e){const n=document.getElementById("qrCodeContainer");let i=n==null?void 0:n.querySelector("bitcoin-qr");if(!n||!e)return;i&&i.remove();const t=Math.min(Math.floor(window.innerWidth/3),300),o=Math.round(t/100)*100;i=document.createElement("bitcoin-qr"),i.setAttribute("lightning",e),i.setAttribute("type","svg"),i.setAttribute("width",o.toString()),i.setAttribute("height",o.toString()),i.setAttribute("dots-color","#ff9900"),i.setAttribute("background-color","transparent"),i.setAttribute("corners-square-color","#ff9900"),i.setAttribute("poll-interval","3000"),i.setAttribute("is-polling","true"),n.appendChild(i),console.log("QR code updated with invoice:",e.substring(0,20)+"...")}async updateLightningDetails(e){try{const{decodeInvoice:n}=await v(async()=>{const{decodeInvoice:o}=await import("./index.modern-GuuHck_z.js");return{decodeInvoice:o}},[]),i=n(e),t=document.getElementById("lightningExpiry");if(i&&t){if(i.timestamp&&i.expiry){const o=new Date((i.timestamp+i.expiry)*1e3);if(o-new Date>0){const l=o.getMonth()+1,a=o.getDate(),u=o.getFullYear(),f=o.getHours(),h=o.getMinutes(),b=f>=12?"PM":"AM",g=f%12||12,p=h.toString().padStart(2,"0"),A=`${l}/${a}/${u} ${g}:${p} ${b}`;t.textContent=`Expires: ${A}`}else t.textContent="Expired"}else t.textContent="Expiration time not available";t.style.display="inline-block"}else t&&(t.style.display="none")}catch(n){console.error("Error updating Lightning details:",n);const i=document.getElementById("lightningExpiry");i&&(i.style.display="none")}}updatePreviewTable(e){const n=document.getElementById("previewItemsTable");if(n&&(n.innerHTML="",e.forEach(i=>{const t=document.createElement("tr");t.innerHTML=`
                <td>${E(i.description)}</td>
                <td>${i.quantity}</td>
                <td>${I(i.rate)}</td>
                <td class="amount">${I(i.amount)}</td>
